...
Solutions architect building **agentic engineering workflows** — I run OpenAI Codex CLI and Claude Code side-by-side, in parity, on real production codebases, and I've spent 20+ years deploying enterprise software into regulated industries (pharma, financial services, government, oil & gas).
...
Two consumer iOS apps on the App Store (Gaurava, Withul) — built end-to-end with agent workflows. Most of my day-job work (enterprise Documentum/cloud deployments, agentic ops tooling, LLM fine-tuning POCs) lives in private repos.
